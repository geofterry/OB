                ...
                for (int i = 0; i < noOrderRedeemNo.Count;i++ )
                {
                    if(tempFinalJenisOrder[i]=="Voucher"){
                        if(status[i]=="Success"){
                            ...
                            if (i == 0)
                            {
                                con.executeUpdate("INSERT INTO OrderVoucher VALUES('" + noOrderRedeemNo[i] + "','" + finalTanggal[i] + "','" + tempFinalVoucher[i] + "','" + tempFinalClaimer[i] + "','" + tempFinalJumlahVoucher[i] + "','" + tempFinalPecahanVoucher[i] + "','" + tempFinalDelivery[i] + "','" + tempFinalEmail[i] + "','" + tempFinalTelepon[i] + "','" + tempFinalAlamat[i] + "','" + status[i] + "','" + MDIform.username + "')");
                            }
                            ...
                            con.executeUpdate("INSERT INTO DetailOrderVoucher VALUES('" + finalTadaNo[i] + "','F" + noOrderRedeemNo[i] + "','" + finalTerpakai[i] + "')");
                            if (i == 0)
                            {
                                con.executeUpdate("INSERT INTO OrderVoucher VALUES('F" + noOrderRedeemNo[i] + "','" + finalTanggal[i] + "','" + tempFinalVoucher[i] + "','" + tempFinalClaimer[i] + "','" + tempFinalJumlahVoucher[i] + "','" + tempFinalPecahanVoucher[i] + "','" + tempFinalDelivery[i] + "','" + tempFinalEmail[i] + "','" + tempFinalTelepon[i] + "','" + tempFinalAlamat[i] + "','" + status[i] + "','" + MDIform.username + "')");
                            }
                            else if (noOrderRedeemNo[i] != noOrderRedeemNo[i - 1])
                            {
                                con.executeUpdate("INSERT INTO OrderVoucher VALUES('F" + noOrderRedeemNo[i] + "','" + finalTanggal[i] + "','" + tempFinalVoucher[i] + "','" + tempFinalClaimer[i] + "','" + tempFinalJumlahVoucher[i] + "','" + tempFinalPecahanVoucher[i] + "','" + tempFinalDelivery[i] + "','" + tempFinalEmail[i] + "','" + tempFinalTelepon[i] + "','" + tempFinalAlamat[i] + "','" + status[i] + "','" + MDIform.username + "')");
                        ...
                        if (status[i] == "Success" )
                        {
                            ...
                            if(i==0){
                                con.executeUpdate("INSERT INTO RedeemCash VALUES('" + noOrderRedeemNo[i] + "','" + finalTanggal[i] + "','" + tempFinalClaimer[i] + "','" + tempFinalNamaBank[i] + "','" + tempFinalTelepon[i] + "','" + tempFinalNamaRekening[i] + "','" + tempFinalNoRekening[i] + "','" + tempFinalNamaCabang[i] + "','" + status[i] + "','" + MDIform.username + "')");
                            }
                            else if (noOrderRedeemNo[i] != noOrderRedeemNo[i - 1])
                            {
                                con.executeUpdate("INSERT INTO RedeemCash VALUES('" + noOrderRedeemNo[i] + "','" + finalTanggal[i] + "','" + tempFinalClaimer[i] + "','" + tempFinalNamaBank[i] + "','" + tempFinalTelepon[i] + "','" + tempFinalNamaRekening[i] + "','" + tempFinalNoRekening[i] + "','" + tempFinalNamaCabang[i] + "','" + status[i] + "','" + MDIform.username + "')");
                            ...
                            con.executeUpdate("INSERT INTO DetailRedeemCash VALUES('" + finalTadaNo[i] + "','F" + noOrderRedeemNo[i] + "','" + finalTerpakai[i] + "')");
                            if (i == 0)
                            {
                                con.executeUpdate("INSERT INTO RedeemCash VALUES('F" + noOrderRedeemNo[i] + "','" + finalTanggal[i] + "','" + tempFinalClaimer[i] + "','" + tempFinalNamaBank[i] + "','" + tempFinalTelepon[i] + "','" + tempFinalNamaRekening[i] + "','" + tempFinalNoRekening[i] + "','" + tempFinalNamaCabang[i] + "','" + status[i] + "','" + MDIform.username + "')");
                            }
                            else if (noOrderRedeemNo[i] != noOrderRedeemNo[i - 1])
                            {
                                con.executeUpdate("INSERT INTO RedeemCash VALUES('F" + noOrderRedeemNo[i] + "','" + finalTanggal[i] + "','" + tempFinalClaimer[i] + "','" + tempFinalNamaBank[i] + "','" + tempFinalTelepon[i] + "','" + tempFinalNamaRekening[i] + "','" + tempFinalNoRekening[i] + "','" + tempFinalNamaCabang[i] + "','" + status[i] + "','" + MDIform.username + "')");
                        ...
                        if (status[i] == "Success" )
                        {
                            ...
                            if(i==0){
                                con.executeUpdate("INSERT INTO Donate VALUES('" + noOrderRedeemNo[i] + "','" + tempFinalYayasan[i] + "','" + finalTanggal[i] + "','" + tempFinalClaimer[i] + "','" + status[i] + "','" + MDIform.username + "')");
                            }
                            else if (noOrderRedeemNo[i] != noOrderRedeemNo[i - 1])
                            {
                                con.executeUpdate("INSERT INTO Donate VALUES('" + noOrderRedeemNo[i] + "','" + tempFinalYayasan[i] + "','" + finalTanggal[i] + "','" + tempFinalClaimer[i] + "','" + status[i] + "','" + MDIform.username + "')");
                            ...
                            con.executeUpdate("INSERT INTO DetailDonate VALUES('" + finalTadaNo[i] + "','F" + noOrderRedeemNo[i] + "','" + finalTerpakai[i] + "')");
                            if(i==0){
                                con.executeUpdate("INSERT INTO Donate VALUES('F" + noOrderRedeemNo[i] + "','" + tempFinalYayasan[i] + "','" + finalTanggal[i] + "','" + tempFinalClaimer[i] + "','" + status[i] + "','" + MDIform.username + "')");
                            }
                            else if (noOrderRedeemNo[i] != noOrderRedeemNo[i - 1])
                            {
                                con.executeUpdate("INSERT INTO Donate VALUES('F" + noOrderRedeemNo[i] + "','" + tempFinalYayasan[i] + "','" + finalTanggal[i] + "','" + tempFinalClaimer[i] + "','" + status[i] + "','" + MDIform.username + "')");
                        ...
                        if (status[i] == "Success" )
                        {
                            ...
                            if(i==0){
                                con.executeUpdate("INSERT INTO OrderItem VALUES('" + noOrderRedeemNo[i] + "','" + tempFinalClaimer[i] + "', '" + finalTanggal[i] + "', '" + tempFinalKategori[i] + "','" + tempFinalBarang[i] + "','" + tempFinalJumlahItem[i] + "','" + tempFinalHargaItem[i] + "','" + tempFinalDelivery[i] + "', '" + tempFinalEmail[i] + "','" + tempFinalTelepon[i] + "','" + tempFinalAlamat[i] + "','" + status[i] + "','" + MDIform.username + "')");
                            }
                            else if (noOrderRedeemNo[i] != noOrderRedeemNo[i - 1])
                            {
                                con.executeUpdate("INSERT INTO OrderItem VALUES('" + noOrderRedeemNo[i] + "','" + tempFinalClaimer[i] + "', '" + finalTanggal[i] + "', '" + tempFinalKategori[i] + "','" + tempFinalBarang[i] + "','" + tempFinalJumlahItem[i] + "','" + tempFinalHargaItem[i] + "','" + tempFinalDelivery[i] + "', '" + tempFinalEmail[i] + "','" + tempFinalTelepon[i] + "','" + tempFinalAlamat[i] + "','" + status[i] + "','" + MDIform.username + "')");
                            ...
                            con.executeUpdate("INSERT INTO DetailOrderItems VALUES('" + finalTadaNo[i] + "','F" + noOrderRedeemNo[i] + "','" + finalTerpakai[i] + "')");
                            if (i == 0)
                            {
                                con.executeUpdate("INSERT INTO OrderItem VALUES('F" + noOrderRedeemNo[i] + "','" + tempFinalClaimer[i] + "', '" + finalTanggal[i] + "', '" + tempFinalKategori[i] + "','" + tempFinalBarang[i] + "','" + tempFinalJumlahItem[i] + "','" + tempFinalHargaItem[i] + "','" + tempFinalDelivery[i] + "', '" + tempFinalEmail[i] + "','" + tempFinalTelepon[i] + "','" + tempFinalAlamat[i] + "','" + status[i] + "','" + MDIform.username + "')");
                            }
                            else if (noOrderRedeemNo[i] != noOrderRedeemNo[i - 1])
                            {
                                con.executeUpdate("INSERT INTO OrderItem VALUES('F" + noOrderRedeemNo[i] + "','" + tempFinalClaimer[i] + "', '" + finalTanggal[i] + "', '" + tempFinalKategori[i] + "','" + tempFinalBarang[i] + "','" + tempFinalJumlahItem[i] + "','" + tempFinalHargaItem[i] + "','" + tempFinalDelivery[i] + "', '" + tempFinalEmail[i] + "','" + tempFinalTelepon[i] + "','" + tempFinalAlamat[i] + "','" + status[i] + "','" + MDIform.username + "')");
